  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-gray-200 mb-6 relative">
          ...
          {!isSignUp && (
            <Link
              to="/reset"
              className="text-sm text-gray-300 float-right my-4 hover:text-custom-purple-700"
            >
              Forgot Password?
            </Link>
          )}
          {passFocus && !validPassword && (
            <div className="bg-slate-800 rounded p-2 text-xs text-amber-700 absolute w-full">
              must be at least 8 characters and include atleast one capital
              letter, number, and !@#$%.
            </div>
          )}
        </div>
